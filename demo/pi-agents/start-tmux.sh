...
COMMON='source /tmp/arcad-agents.env; [[ -f /tmp/arcad-server.env ]] && source /tmp/arcad-server.env; export ARCADE_API_URL=http://localhost:8787/api ARCADE_PAYMENT_MODE=circle ARCAD_PI_WAKE=1 ARCAD_PI_WAKE_MS=15000 ARCAD_MARKET_WATCH_MS=5000 PI_MODEL=quotio/gpt-5.4-mini QUOTIO_API_KEY=test-key ARCAD_WATCH_AGENTS=mission-control-ai:arcad-mission-control-ai,sutro-inference:arcad-sutro-inference'
